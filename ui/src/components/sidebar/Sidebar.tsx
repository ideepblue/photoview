...
export const Sidebar = () => {
  ...
  return (
    <div
      className={`fixed top-[72px] z-[110] bg-white dark:bg-dark-bg2 dark:border-dark-border2 bottom-0 w-full overflow-y-auto transform transition-transform motion-reduce:transition-none ${
