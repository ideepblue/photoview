...
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Fullscreen viewer  | Pointer-driven left/right/up/down swipes with a following neighbor, commit/rebound animation, axis locking, keyboard/button compatibility, and reduced-motion support. The active position and filename are individually switchable from a persistent quick-control preference. A tiny status mark distinguishes the thumbnail preview from the loaded high-resolution resource without covering the photo.                                                                                                                                 |
